            ...
            while not state_machine.is_episode_done:
                ...
                if args.expert == "autogen_reference" and (phase_changed or completed_steps % 30 == 0):
                    print(
                        ...
                        f"green_ray_segment_length="
                        f"{None if state_machine.green_ray_segment_length is None else _rounded_row(state_machine.green_ray_segment_length, digits=7)}:"
                        f"cube_projection_on_grasp_segment="
                        f"{None if state_machine.cube_projection_on_grasp_segment is None else _rounded_row(state_machine.cube_projection_on_grasp_segment, digits=7)}:"
                        f"cube_distance_to_grasp_segment="
                        f"{None if state_machine.cube_distance_to_grasp_segment is None else _rounded_row(state_machine.cube_distance_to_grasp_segment, digits=7)}:"
