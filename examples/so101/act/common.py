...
def ensure_original_episode_index_lookup(dataset: Any, episodes: Iterable[int]) -> bool:
    """Expand compact LeRobot subset bounds so original episode IDs remain valid.
